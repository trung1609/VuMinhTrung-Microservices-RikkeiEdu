...
import com.trung.orderservice.dto.event.OrderCreatedEvent;
import com.trung.orderservice.dto.request.CreateOrderRequest;
import com.trung.orderservice.dto.request.OrderCreateDTO;
...
public class OrderServiceImpl implements OrderService {
    ...
    public ApiResponse<OrderResponse> createOrder(CreateOrderRequest request) {
        ...
        for (OrderItem item : orderItems) {
         ...
         // Gửi OrderCreatedEvent với đủ thông tin cho email-service và shipping-service
